 ...
 * @abstract String utility function that allows the conversion between
 * JS string and C0 string.
 */

import { isNullPtr } from "./pointer_utility";
 ...
 */
export function loadString(ptr: C0Value<Maybe<"string">>, allocator: C0HeapAllocator): string {
